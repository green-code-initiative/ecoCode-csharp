...
internal static class TypeRegistrarService
{
    public static ITypeRegistrar CreateRegistrar(ServiceCollection services) => new TypeRegistrar(services);

    private sealed class TypeRegistrar(ServiceCollection builder) : ITypeRegistrar
    {
