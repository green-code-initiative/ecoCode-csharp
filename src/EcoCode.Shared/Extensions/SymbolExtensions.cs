...
public static class SymbolExtensions
{
    ...
    /// <summary>Returns the original symbol overridden by the given symbol.</summary>
    /// <param name="symbol">The symbol.</param>
    /// <returns>The overriden symbol, null if none.</returns>
    public static ISymbol? OverridenSymbol(this ISymbol symbol) => symbol switch
    {
